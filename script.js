...
//   // generates the computer's picks that the player is trying to guess
//   oneA = colors[Math.floor(Math.random() * 6)];
//   twoA = colors[Math.floor(Math.random() * 6)];
//   threeA = colors[Math.floor(Math.random() * 6)];
//   fourA = colors[Math.floor(Math.random() * 6)];

//   answer = [oneA, twoA, threeA, fourA];
//   console.log(answer);
//   // ultAnswer = [oneA, twoA, threeA, fourA];
//   count = 0;
// }

// // recording users selected colors

// var userSelection = " ";

// const clrselector = document.querySelectorAll(".pegsc");

// clrselector.forEach(btn => {
...
//     // const addclr = document.querySelector('.th');
//     // addclr.classList.add(color);
// };
    ...
    var code = [], // Color sequence the player needs to guess
        ...
        function gameSetup () {
          ...
          function insertPeg (type) {
            var sockets = hintContainer[hintContainer.length - hintIncrement].getElementsByClassName('checkBox');
          ...
          function clearBoard () {
            ...
            for (var i = 0; i < hintContainer.length; i++) {
              ...
              for (var j = 0; j < 4; j++) {
                socketCollection[j].className = 'checkBox';
              }
            }
